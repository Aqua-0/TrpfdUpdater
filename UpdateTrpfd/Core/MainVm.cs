...
namespace TrpfdManager
{
    public sealed class MainVm : INotifyPropertyChanged
    {
        ...
        public TrpfdManager.Core.WatchHandle? _watcher;
        ...
        public bool ShowLog { get => _showLog; set { _showLog = value; OnChanged(); } }
        public bool IsDark { get => _isDark; set { _isDark = value; OnChanged(); } }
        ...
        public int SelectedTabIndex { get => _selectedTabIndex; set { _selectedTabIndex = value; OnChanged(); } }

        public ObservableCollection<string> Log { get; } = new();
        public TrpfdManager.Core.OverlayVm Overlay { get; } = new();
        public ModsVm Mods { get; } = new();

        public void LogAdd(string msg)
        {
            if (string.IsNullOrWhiteSpace(msg)) return;
            var disp = System.Windows.Application.Current?.Dispatcher;
            if (disp != null && !disp.CheckAccess()) { disp.Invoke(() => LogAdd(msg)); return; }
